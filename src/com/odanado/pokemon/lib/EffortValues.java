...
public class EffortValues {
	 ...
	 * @param Speed
	 */
	public EffortValues(int HP, int Attack, int Defense, int SpAttack,int SpDefense, int Speed) {
		this.HP = HP;
		this.Attack = Attack;
  ...
  public EffortValues(int[] values) {
	 ...
	 * @param Speed
	 */
	public EffortValues(String HP, String Attack, String Defense, String SpAttack,String SpDefense, String Speed) {
